 ...
 * @returns {string[]}
 */
export const buildColumns = (string, nroColumns) => {
 ...
 */
export const iterateArrayStringDiagonally = (arrayString, callback) => {
 ...
 * @param {function} callback 
 */
export const iterateArrayStringValues = (arrayString, callback) => {
 ...
 * @returns {string[]}
 */
export const splitStringbyLength = (string, length) => {
    let i = 0, res = []
 ...
 * @param {string} string 
 */
export const getOrderIndexAlpha = (key) => {
